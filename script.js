...
const boutonNouvelleCitation = document.getElementById('nouveau')

let dernier
let nombreAleatoire

function genererNombreAleatoire(tailleTableau) {
    let resultat
    do {
        resultat = Math.floor(Math.random() * tailleTableau)
    }
    while (resultat === dernier)
    dernier = resultat
    return resultat
}
